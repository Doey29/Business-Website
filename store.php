...
<div class="headertexts">
  ...
  <div>
    ...
    <section class="contactpage rta">
      <div class="contactcontainer">
        <div class="row">
          <div class="col-xl-9 mx-auto">
            <div class="rta-inner text-center rounded">
              <h2 class="section-heading mb-5">Connect with us</h2>
              <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                <li class="list-unstyled-item list-hours-item d-flex" style="font-weight: 700; color: #e6a756; ">
                ...
                <li class="list-unstyled-item list-hours-item d-flex">
                  Email
                  <span class="ml-auto">kakeclothing2020@gmail.com</span>
                </li>
                <li class="list-unstyled-item list-hours-item d-flex">
                  Mobile No. 1
...
<!--
  ...
  -->
    ...
    <footer class="footer text-faded text-center py-4" id="footercontacts">
      <div class="container">
        <p class="m-0 small">Copyright &copy; ITCC 2021 <br> Chiong Hawan Sobiono</p>
      </div>
    </footer>
